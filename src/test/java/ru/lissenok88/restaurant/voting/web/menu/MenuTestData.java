...
public class MenuTestData {
    ...
    public static final Menu menu2_1 = new Menu(MENU1_ID + 4, "Паста с грибами", 125, restaurant_2, CURRENT_DATE);
    public static final Menu menu2_2 = new Menu(MENU1_ID + 5, "Капучино", 150, restaurant_2, CURRENT_DATE);
    public static final Menu menu3_1 = new Menu(MENU1_ID + 6, "Салат Министерский", 75, restaurant_3, CURRENT_DATE);
    public static final Menu menu3_2 = new Menu(MENU1_ID + 7, "Солянка", 150, restaurant_3, CURRENT_DATE);
    public static final Menu menu3_3 = new Menu(MENU1_ID + 8, "Картофельное пюре", 100, restaurant_3, CURRENT_DATE);
    public static final Menu menu3_4 = new Menu(MENU1_ID + 9, "Котлета", 50, restaurant_3, CURRENT_DATE);
    public static final Menu menu3_5 = new Menu(MENU1_ID + 10, "Чай", 30, restaurant_3, CURRENT_DATE);
    ...
    public static Menu getNew() {
        return new Menu(null, "Салат Греческий", 100, restaurant_1, CURRENT_DATE);
    }
